...
from TractionGuest.watchlists_api import WatchlistsApi  # noqa: E501
...
class TestWatchlistsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = TractionGuest.watchlists_api.WatchlistsApi()  # noqa: E501
