...
from TractionGuest.models.signin_watchlist import SigninWatchlist  # noqa: E501
from TractionGuest.rest import ApiException

class TestSigninWatchlist(unittest.TestCase):
    """SigninWatchlist unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SigninWatchlist
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = TractionGuest.models.signin_watchlist.SigninWatchlist()  # noqa: E501
        if include_optional :
