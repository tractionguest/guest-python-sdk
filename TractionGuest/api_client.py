...
from TractionGuest import rest
from TractionGuest.configuration import Configuration
from TractionGuest.exceptions import ApiTypeError, ApiValueError, ApiException
from TractionGuest.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuditLogsApi()
        api_instance.get_audit_log  # this is an instance of the class Endpoint
        api_instance.get_audit_log()  # this invokes api_instance.get_audit_log.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_audit_log.callable or self.callable in this class
