...
class PaginatedLocationsList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, locations, pagination, *args, **kwargs):  # noqa: E501
        """PaginatedLocationsList - a model defined in OpenAPI
