...
class PackageCreateParams(ModelNormal):
    ...
    attribute_map = {
        'base64_image': 'base64_image',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, base64_image, location_id, *args, **kwargs):  # noqa: E501
        """PackageCreateParams - a model defined in OpenAPI
