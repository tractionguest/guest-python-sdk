...
class PaginatedSigninsList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, pagination, signins, *args, **kwargs):  # noqa: E501
        """PaginatedSigninsList - a model defined in OpenAPI
