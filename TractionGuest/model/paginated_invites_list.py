...
class PaginatedInvitesList(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, invites, pagination, *args, **kwargs):  # noqa: E501
        """PaginatedInvitesList - a model defined in OpenAPI
