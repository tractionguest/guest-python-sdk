...
class Error(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, domain, code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            attribute (str, none_type): The model attribute where the error occured. [optional]  # noqa: E501
            message (str, none_type): A human readable error message that can be discarded for internationalization purposes. [optional]  # noqa: E501
        """
