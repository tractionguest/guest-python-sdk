...
class NotificationTrigger1(object):
    ...
    def __init__(self, offset_unit=None, notification_groups=None, email_template_id=None, offset_origin=None, offset_amount=None, offset_direction=None, local_vars_configuration=None):  # noqa: E501
        """NotificationTrigger1 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def offset_unit(self):
        """Gets the offset_unit of this NotificationTrigger1.  # noqa: E501

        Whether the offset should be calculated as `days` or `hours`  # noqa: E501

        :return: The offset_unit of this NotificationTrigger1.  # noqa: E501
        :rtype: str
        """
    ...
    def offset_unit(self, offset_unit):
        """Sets the offset_unit of this NotificationTrigger1.

        Whether the offset should be calculated as `days` or `hours`  # noqa: E501

        :param offset_unit: The offset_unit of this NotificationTrigger1.  # noqa: E501
        :type: str
        """
    ...
    def notification_groups(self):
        """Gets the notification_groups of this NotificationTrigger1.  # noqa: E501

        An array made of only `INVITEE`, `HOSTS, or `LEP` as possible string values  # noqa: E501

        :return: The notification_groups of this NotificationTrigger1.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def notification_groups(self, notification_groups):
        """Sets the notification_groups of this NotificationTrigger1.

        An array made of only `INVITEE`, `HOSTS, or `LEP` as possible string values  # noqa: E501

        :param notification_groups: The notification_groups of this NotificationTrigger1.  # noqa: E501
        :type: list[str]
        """
    ...
    def email_template_id(self):
        """Gets the email_template_id of this NotificationTrigger1.  # noqa: E501


        :return: The email_template_id of this NotificationTrigger1.  # noqa: E501
        :rtype: int
        """
    ...
    def email_template_id(self, email_template_id):
        """Sets the email_template_id of this NotificationTrigger1.


        :param email_template_id: The email_template_id of this NotificationTrigger1.  # noqa: E501
        :type: int
        """
    ...
    def offset_origin(self):
        """Gets the offset_origin of this NotificationTrigger1.  # noqa: E501

        Whether the offset should be calculated from the start, or finish of the event  # noqa: E501

        :return: The offset_origin of this NotificationTrigger1.  # noqa: E501
        :rtype: str
        """
    ...
    def offset_origin(self, offset_origin):
        """Sets the offset_origin of this NotificationTrigger1.

        Whether the offset should be calculated from the start, or finish of the event  # noqa: E501

        :param offset_origin: The offset_origin of this NotificationTrigger1.  # noqa: E501
        :type: str
        """
    ...
    def offset_amount(self):
        """Gets the offset_amount of this NotificationTrigger1.  # noqa: E501

        The amount to offset the notification from the event  # noqa: E501

        :return: The offset_amount of this NotificationTrigger1.  # noqa: E501
        :rtype: int
        """
    ...
    def offset_amount(self, offset_amount):
        """Sets the offset_amount of this NotificationTrigger1.

        The amount to offset the notification from the event  # noqa: E501

        :param offset_amount: The offset_amount of this NotificationTrigger1.  # noqa: E501
        :type: int
        """
    ...
    def offset_direction(self):
        """Gets the offset_direction of this NotificationTrigger1.  # noqa: E501

        Whether the offset should be calculated for before, or after the event  # noqa: E501

        :return: The offset_direction of this NotificationTrigger1.  # noqa: E501
        :rtype: str
        """
    ...
    def offset_direction(self, offset_direction):
        """Sets the offset_direction of this NotificationTrigger1.

        Whether the offset should be calculated for before, or after the event  # noqa: E501

        :param offset_direction: The offset_direction of this NotificationTrigger1.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NotificationTrigger1):
            return False
